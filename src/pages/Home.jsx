...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchRentListings = async () => {
      try {
        const res = await fetch('https://cartrader-api.onrender.com/api/listing/get?type=rent&limit=4', {credentials: 'include'});
        const data = await res.json();
    ...
    const fetchSaleListings = async () => {
      try {
        const res = await fetch('https://cartrader-api.onrender.com/api/listing/get?type=sale&limit=4', {credentials: 'include'});
        const data = await res.json();
    ...
    <div>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto'>
        ...
        <div className='text-gray-400 text-xs sm:text-sm'>
          Car Trader is the best place to find your perfect vehicle.
          <br />
